...
--
-- Host: localhost:3306
-- Waktu pembuatan: 02 Bulan Mei 2025 pada 06.43
...
(1, 'admin', 'admin', 'admin', '082334573160', 'admin@admin');
...
(100, 'user@user', 'user', '081231236213', 'Laki-Laki', 'user', 'malang', '681400b3d8bae.png');
...
--
ALTER TABLE `sewa_212279`
  MODIFY `212279_id_sewa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
